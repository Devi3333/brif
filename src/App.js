...
export default function App() {
    return (_jsx(Router, { children: _jsx(Shell, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Dashboard, {}) }), _jsx(Route, { path: "/uploads", element: _jsx(UploadsPage, {}) }), _jsx(Route, { path: "/meetings", element: _jsx(MeetingsList, {}) }), _jsx(Route, { path: "/meetings/:id", element: _jsx(MeetingDetailRoute, {}) }), _jsx(Route, { path: "/speakers", element: _jsx(SpeakersPage, {}) }), _jsx(Route, { path: "/qa", element: _jsx(QAPage, {}) }), _jsx(Route, { path: "/jobs", element: _jsx(JobsPage, {}) }), _jsx(Route, { path: "/settings", element: _jsx(SettingsPage, {}) })] }) }) }));
}
